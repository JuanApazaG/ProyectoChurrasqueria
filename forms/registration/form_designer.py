...
class FormRegisterDesigner():
    ...
    def __init__(self):
        ...
        logo = utl.leer_imagen("./imagenes/logoChurrasqueria.png", (150, 150))
        # frame_logo
        ...
        title = tk.Label(frame_form_top, text="Registro de usuario", font=(
            'Impact', 30, "italic"), fg="#d46c91", bg='#fcfcfc', pady=30)
        ...
        inicio = tk.Button(frame_form_fill, text="Registrar", font=(
            'Georgia', 15), bg='#d46c91', bd=0, fg="#fff", command=self.register)
